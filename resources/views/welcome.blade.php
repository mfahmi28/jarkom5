...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-nunito">
        <span class="text-3xl underline" id="clickMe">
            Hello world!
        </span>
        <br>
        <span class="text-3xl font-semibold underline text-secondary" id="clickMe">
            Hello world!
        </span>
        <br>
        <span class="text-3xl font-bold underline text-primary" id="clickMe">
            Hello world!
        </span>
        <br><br>
        <table class="w-full">
